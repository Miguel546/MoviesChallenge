package com.luismiguel.movieschallenge.ui.home.upcoming.rv
...
@Singleton
class UpcomingAdapter @Inject constructor(): RecyclerView.Adapter<UpcomingAdapter.UpcomingViewHolder>() {
